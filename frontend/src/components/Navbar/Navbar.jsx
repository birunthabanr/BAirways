...
const Navbar = () => {
    ...
    useEffect(() => {
      axios.get("http://localhost:5174/register/", {
        headers:{
      ...
      <header className="header">
          ...
          <nav className='navbar flex items-center space-x-6'>
              ...
              { !authState ? (
                ...
                <button className='px-3 py-1 rounded-md border-[2px] border-blue-400 border-solid blueShadow gap-4' onClick={handleLogOutClick}>
                      <p>Log out</p> 
                    </button>
              )}
          </nav>
